...
Under sustained high-load testing (5 consecutive back-to-back runs with continuous ETW ingestion, NDIS JA3 extraction, Aho-Corasick threat-intel matching, and native FFI ML batching), the C2Sensor stayed exceptionally lightweight: CPU usage peaked at only 7-15% and RAM consumption never exceeded 200 MB.